    ...
    return(
        <div className="card mb-3 mt-3" style={{width: "650px", height: "350px"}}>
            <div className="row g-0 overflow-auto">
                <div className="card-header d-flex justify-content-between align-items-center" style={{height: "15%"}}>
                    <div className="row w-100">
                        <div className="col-sm d-flex justify-content-center">
                            <p className="my-2">BookWorm Rating:</p>
                        </div>
                        <div className="col-sm d-flex justify-content-center">
                            <button className="btn" type="button" onClick={props.onClickFav}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star" viewBox="0 0 16 16">
